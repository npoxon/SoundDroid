...
import uk.co.peartree_productions.sounddroid.soundcloud.SoundCloud;
import uk.co.peartree_productions.sounddroid.soundcloud.SoundCloudService;
import uk.co.peartree_productions.sounddroid.soundcloud.Track;

import static uk.co.peartree_productions.sounddroid.soundcloud.SoundCloudService.*;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                try {
                    mMediaPlayer.setDataSource(selectedTrack.getStreamURL()+"?client_id="+ CLIENT_ID);
        ...
        service.getMostRecent(new SimpleDateFormat("yyyy-MM-dd hh:mm:ss").format(new Date()), new Callback<List<Track>>() {
            @Override
